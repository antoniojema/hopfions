...
if ARG2 == 'sim':
	...
	if ARG1 == 'E':
		...
		if n == 60:
			...
			line.seed.widget.center = [137.46,125.14,100.75]
			line.seed.widget.radius = 5
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 1000
			line.seed.widget.center = [162.37,102,100]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
			...
			line.seed.widget.center = [128.986074918827,52.39050840039495,110.49]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
		...
		if n == 60:
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [142.41,98.91,100]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [143.1,136.91,99.5]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [152.20651084101144,128.6638145818975,102.7946086111072]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
		...
		for i in range(20):
			...
			line[i].stream_tracer.maximum_propagation = 100
			line[i].seed.widget.position = [100+40*np.cos(2.*np.pi*i/20),100+40*np.sin(2.*np.pi*i/20),70.25*(n-120)/(1-120)+129.93*(n-1)/(120-1)]
	...
	#mlab.savefig('../hopfions_memoria/video/23_flow_'+str(n)+'_'+ARG1+'_'+ARG2+'.png',size=(1366,1366))
...
###################################################################### v TEORICO  v
	...
	if ARG1 == 'E':
		...
		if n == 60:
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [38.3727,96.8263,110.49]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
		...
		if n == 60:
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [154.75,132.95,101.87]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
			...
			line.tube_filter.radius = 2
			line.stream_tracer.maximum_propagation = 500
			line.seed.widget.center = [152.99,137.70,104.24]
			line.seed.widget.radius = 5
			line.seed.widget.theta_resolution=5
			line.seed.widget.phi_resolution=5
