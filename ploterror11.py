...
def iteration(n):
	...
	if n in [1,30,60,90,120,150,180,200]:
		plt.savefig('../hopfions_memoria/media/error/11_Error_'+field+'_'+plane+'_'+str(n)+'.png')
...
animation.save('error/11_Error_'+field+'_'+plane+'.mp4',writer=writer)

plt.figure()
plt.plot(max_error)
plt.xlabel('Iteration')
plt.ylabel('Max. error')
plt.savefig('error/11_Error_'+field+'_'+plane+'.png')

fout = h5.File('error/11_Error_'+field+'_'+plane+'.h5','w')
